...
class Groups {
    ...
    info ({ roomId = undefined, roomName = undefined }, callback) {
        return this.client.request("GET", "groups.info", pageQueryMapping(arguments[0]), callback);
    }
    ...
    messages ({ offset = 0, count = 0, sort = undefined, fields = undefined, query = undefined, roomName = undefined, roomId = undefined }, callback) {
        return this.client.request("GET", "groups.messages", pageQueryMapping(arguments[0]), callback);
    }
