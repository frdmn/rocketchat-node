...
class Channels {
    ...
    messages (roomId, { offset = 0, count = 0, sort = undefined, fields = undefined, query = undefined}, callback) {
        let options = {roomId};
        Object.assign(options, pageQueryMapping(arguments[1]));
        return this.client.request("GET", "channels.messages", options, callback);
    }
